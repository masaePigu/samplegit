...
<body>
	...
	<form action="./PaymentServlet" method="post">
		...
		<div id="r">
			<input type="radio" id="r1" name="radiod" value="1" required
				onclick="clickBtn3()" /><label for="r1">当日</label> <input
		...
		<script>
			...
			function clickBtn1() {
				...
				document.getElementById("card-month").required = true ;
				document.getElementById("card-year").required = true ;
				document.getElementById("securitycode").required = true ;
				document.getElementById("paymentnum").required = true ;
			}
		</script>
		...
		<input type="submit" value="確定" id="commit">
	</form>
	...
	<script>
		...
		function clickBtn2() {
			...
			document.getElementById("r2").required = false ;
			document.getElementById("cardname").required = false ;
			document.getElementById("cardnumber").required = false ;
			document.getElementById("card-month").required = false ;
			document.getElementById("card-year").required = false ;
			document.getElementById("securitycode").required = false ;
			document.getElementById("paymentnum").required = false ;
